...
document.querySelector('#Director').addEventListener('click', function() {
    ...
    var subject = "Concern Regarding Increased Mess Fee and Tuition Fee";
    var body = `
Respected Director Sir,

This email is to express our growing concern regarding the recent increase in the mess & tuition fee. 

Many students are already facing significant financial difficulties.  The sudden hike in the fee is overwhelming for those of us without scholarships or fee remissions. Moreover, several students who qualify for fee remission have not yet received it, which adds to their financial strain.
